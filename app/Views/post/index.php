                  ...
                  <div class="card-body">
                              <h4 class="card-title float-left"><?= $pages ?></h4>
                                <div class="card-title float-right">
                                    <a href="<?= base_url('dashboard/post/add') ?>" class="btn btn-primary btn-md"><i
                                                    class="far fa-user-plus"></i> Tambah Post</a>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif($row->status === 'publish'): ?>
                                                        <label class="badge badge-success"><?= strtoupper($row->status) ?></label>
                                                    <?php endif ?>
                                                </td>
                                                <td>
                                                <a href="<?= base_url('dashboard/post/edit/'.$row->id) ?>" class="btn btn-warning"><i
                                                    class="far fa-edit"></i> Edit</a>
                                                <a href="<?= base_url('dashboard/post/delete/'.$row->id) ?>" class="btn btn-danger"><i
